...
public class QuestProgression {
    ...
    jPlayer.getPlayer().sendMessage(ChatColor.translateAlternateColorCodes('&', String.format(
        "&5&lQuests: &fCompleted \"%s\"", quest.getQuestName()
    )));
    jPlayer.getPlayer().playSound(jPlayer.getPlayer().getLocation(), Sound.BLOCK_NOTE_BLOCK_CHIME, 1.0f, 1.0f);
